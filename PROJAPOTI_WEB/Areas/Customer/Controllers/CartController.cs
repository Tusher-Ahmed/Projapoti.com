...
namespace PROJAPOTI_WEB.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
            ...
            ShoppingCartVM.OrderHeader.Strate = ShoppingCartVM.OrderHeader.ApplicationUser.State;
        ...
        public IActionResult SummaryPost()
        {
            ...
            ShoppingCartVM.OrderHeader.ApllicationUserId= userId;
		...
		public IActionResult OrderConfirmation(int id)
		{
            ...
            List<ShoppingCart> shoppingCarts = _unitOfWork.ShoppingCart
                .GetAll(u => u.ApplicationUserId == orderHeader.ApllicationUserId).ToList();
